        ...
        <AppShell>
            <div className="w-full max-w-7xl mx-auto flex flex-col h-full font-sans p-2">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-sm text-muted-foreground mt-2">Manage your merchant profile and contact information.</p>
                </div>

                {/* Profile Card */}
                <div className="bg-card rounded-2xl border border-border shadow-sm overflow-hidden mb-6 flex-1 max-w-3xl transition-shadow duration-300 hover:shadow-md">
                    <div className="p-8">

                        {/* Merchant ID Banner */}
                        <div className="flex items-center justify-between bg-indigo-50 dark:bg-indigo-950/50 rounded-xl p-4 mb-8 border border-indigo-100 dark:border-indigo-900/50">
                            <div className="flex items-center gap-4">
                                <div className="h-10 w-10 rounded-full bg-card flex items-center justify-center shadow-sm border border-indigo-100 dark:border-indigo-800">
                                    <Shield className="h-5 w-5 text-indigo-600" />
                                </div>
                                <div>
                                    <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-0.5">Merchant ID</p>
                                    <p className="text-sm font-mono font-medium text-foreground">{merchantId}</p>
                                </div>
                            </div>
                            <button
                                onClick={handleCopy}
